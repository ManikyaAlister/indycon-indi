...
# define model name 
models <- c("group-prior-consensus*age", "group-prior-consensusXclaim-certainty", "group-prior-consensusXclaimXsource", "group-prior-consensus*age", "group-prior-consensus*politcalstrength", "group-prior-consensus*politcalscale", "group-prior-consensus*politcalgroup", "group-prior-consensus*unieducation", "group-prior-consensus*socmedprop")
