...
original_models <- c("group-prior", "group-prior-consensus", "group-prior-consensus-claim", "group-prior-consensusXclaim")
follow_up_models <- c("group-prior-consensusXclaim-certainty", "group-prior-consensusXclaimXsource")
models <- c(original_models, follow_up_models)
...
model_LOOICs <- cbind(model_details, all_looic, all_se, is_follow_up)
