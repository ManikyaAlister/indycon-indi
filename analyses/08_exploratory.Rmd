...
author: "Ee Von Soh & Manikya Alister"
date: "2024-01-16"
output:
...
Although people seemed to be generally more convinced by posts arguing against the claim, the trend whereby a concencus was more convincing when the claim was more knowable appears to hold. 

# How do belief updates change as a funcion of source type?

## Consensus as a function of source type
```{r, message = FALSE}
mean_updates <- data  %>%
...
## Consensus as a function of source type *and* claim type 
```{r}
